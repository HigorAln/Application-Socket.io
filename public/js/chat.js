  ...
  socket.on('notification', data => {
    ...
    if(data.roomId !== idChatRoom){
      ...
      user.insertAdjacentHTML(
        ...
        `) // usado para dicionar as coisas antes
    } 
  })
}
...
document.getElementById("users_list").addEventListener('click', (e) => {
  ...
  // zerar o input de mensagem / tirar notificaticao / iniciar o chat, e mostrar mensagem na tela
...
//   socket.on("message", (data) => {
//     if (data.message.idChatRoom === idChatRoom) {
//       addMessage(data);
//     }
//   });

//   socket.on("notification", (data) => {
//     if (data.idChatRoom !== idChatRoom) {
//       const user = document.getElementById(`user_${data.from._id}`);
